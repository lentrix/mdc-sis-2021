    ...
    $("#department_id").change((ev)=>{
        ...
        $.get('{{url("/api/sections/")}}/' + el.val(), function(response) {
            ...
            response.forEach(function(section) {
                ...
                tr.append("<td>" + section.adviser.name + "</td>")
                tr.append("<td class='text-center'><button class='btn btn-primary section-enrol-btn' data-id='" + section.id + "'><i class='fa fa-arrow-right' data-id='" + section.id + "'></i></button></td>")
            })
        })
    })
